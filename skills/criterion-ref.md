...
Testing Criteria
----------------------------------------
1. [x] User can log in with valid credentials
       → tests/auth_test.rs:L10-25 (test_valid_login)
2. [x] Invalid password shows error message
       → tests/auth_test.rs:L27-45 (test_invalid_password)
```
