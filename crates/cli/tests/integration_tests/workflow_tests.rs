...
async fn test_workflow_add() {
    ...
    let result = cmd.execute(ctx.services.workflows()).await;
...
async fn test_workflow_list() {
    ...
    workflow_add_cmd("workflow1", "Step", "model")
        .execute(ctx.services.workflows())
        .await
        .unwrap();
...
async fn test_workflow_advance() {
    ...
    let add_result = cmd.execute(ctx.services.workflows()).await.unwrap();
    let workflow_id = extract_workflow_id(&add_result);
    ...
    let result = advance_cmd.execute(ctx.services.workflows()).await;
...
async fn test_workflow_retreat() {
    ...
    let result = retreat_cmd.execute(ctx.services.workflows()).await;
...
async fn test_workflow_reject() {
    ...
    let result = reject_cmd.execute(ctx.services.workflows()).await;
