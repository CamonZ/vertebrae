  ...
  return (
    <section aria-label="Recently completed">
      <div className="mb-3 flex items-baseline justify-between border-b border-[var(--color-line)] pb-2">
        <h2 className="flex items-baseline gap-2 font-mono text-eyebrow font-medium uppercase tracking-eyebrow text-[var(--color-ok)]">
          <svg
        ...
        {visibleItems.length > 1 && (
          <button
            ...
            className="font-mono text-eyebrow uppercase tracking-wider text-[var(--color-fg-mute)] transition-colors hover:text-[var(--color-fg-soft)]"
          >
            Dismiss all
          </button>
        )}
