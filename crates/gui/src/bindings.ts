...
async listDaemonFleet(connectionId: string) : Promise<Result<DaemonFleetSnapshot, DaemonCommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("list_daemon_fleet", { connectionId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async getDaemon(connectionId: string, daemonId: string) : Promise<Result<DaemonDetailSnapshot, DaemonCommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_daemon", { connectionId, daemonId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async getDaemonEnrollmentMetadata(connectionId: string, daemonId: string) : Promise<Result<DaemonEnrollmentSnapshot, DaemonCommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_daemon_enrollment_metadata", { connectionId, daemonId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async createDaemon(connectionId: string, name: string | null) : Promise<Result<DaemonBootstrapResult, DaemonCommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("create_daemon", { connectionId, name }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async renameDaemon(connectionId: string, daemonId: string, name: DaemonNameUpdate) : Promise<Result<DaemonMutationResult, DaemonCommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("rename_daemon", { connectionId, daemonId, name }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async unregisterDaemon(connectionId: string, daemonId: string) : Promise<Result<DaemonMutationResult, DaemonCommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("unregister_daemon", { connectionId, daemonId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async rotateDaemonCredentials(connectionId: string, daemonId: string) : Promise<Result<DaemonBootstrapResult, DaemonCommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("rotate_daemon_credentials", { connectionId, daemonId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
